...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <?php
                $placement = mysqli_query($con, "SELECT * FROM student a 
                LEFT JOIN placement b ON a.student_id=b.student_id
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body text-center">
                                                ...
                                                <br><br>
                                                <h2><p>You don't have any students yet! Check back later!</h2>
                                                <br>
                                    ...
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $i = 1;
                                                    while ($std_row = mysqli_fetch_array($placement)) {

                                                        $std_id = $std_row['supervisor_id'];
                                                        $squery = mysqli_query($con, "SELECT * FROM supervisor WHERE supervisor_id = '$std_id'") or die(mysqli_error($con));
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right"> <?php echo $std_row['phone'] ?></td>
                                                        <td class="text-right"> <?php echo $sr['fullname'] ?></td>
                                                        <td class="text-right"> <?php echo $std_row['address'] ?></td>
                                                    </tr>
